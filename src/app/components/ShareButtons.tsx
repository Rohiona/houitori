...
const SHARE_URL = "https://houitori.vercel.app/";
  ...
  return (
    <div className="flex flex-col items-center gap-3 pt-8 pb-4">
      ...
      <div className="flex gap-2">
        <Button variant="outline" size="sm" onClick={handleTwitterShare} className="gap-1">
          <XIcon className="size-4" />
          <span>X</span>
        </Button>
        <Button variant="outline" size="sm" onClick={handleLineShare} className="gap-1">
